...
const CREATE_SYSTEM =
  ...
  "KIND — match the brief. Kanban/board briefs → Inbox/Doing/Done. Cafe/restaurant/shop → landing or menu page, not a task board. Chat/habits/calendar/notes → that kind. Never default every brief to kanban. " +
